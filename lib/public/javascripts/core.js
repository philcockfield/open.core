...
require.define({
"open.client/controls/button": function(exports, require, module) {
  (function() {
  var Button, core;
...
"open.client/controls/button_set": function(exports, require, module) {
  (function() {
  var ButtonSet, core;
  ...
  */
  module.exports = ButtonSet = (function() {
    ...
    /*
      ...
      */
    ButtonSet.prototype.contains = function(button) {
      return this.buttons.include(button);
    };
    /*
      PRIVATE Methods
      */
...
"open.client/controls/index": function(exports, require, module) {
  (function() {
  module.exports = {
...
"open.client/controls/textbox/index": function(exports, require, module) {
  (function() {
...
"open.client/controls/textbox/tmpl": function(exports, require, module) {
  (function() {
...
"open.client/core/base": function(exports, require, module) {
  (function() {
  var Base, Property;
...
"open.client/core/index": function(exports, require, module) {
  (function() {
  var core, using, util;
...
"open.client/core/mvc/_common": function(exports, require, module) {
  (function() {
  var CORE_PATH;
  CORE_PATH = 'open.client/core';
  module.exports = {
    using: function(module) {
      return require("" + CORE_PATH + "/mvc/" + module);
    },
...
"open.client/core/mvc/collection": function(exports, require, module) {
  (function() {
...
"open.client/core/mvc/data_binder": function(exports, require, module) {
  (function() {
  var DataBinder, View, common;
  common = require('open.client/core/mvc/_common');
  View = common.using('view');
  module.exports = DataBinder = (function() {
    function DataBinder(model, view) {
      var bind, element, _i, _len, _ref;
      this.el = common.util.toJQuery(view);
      bind = function(element) {
        var prop, sync;
        prop = model[element.attr('data-bind')];
        sync = function() {
          return element.html(prop());
        };
        sync();
        return prop.onChanged(function(e) {
          return sync();
        });
      };
      _ref = this.el.find('[data-bind]');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        element = _ref[_i];
        bind($(element));
      }
...
"open.client/core/mvc/index": function(exports, require, module) {
  (function() {
  var common, using;
  common = require('open.client/core/mvc/_common');
  using = common.using;
...
"open.client/core/mvc/model": function(exports, require, module) {
  (function() {
...
"open.client/core/mvc/module": function(exports, require, module) {
  (function() {
  ...
  module.exports = Module = (function() {
    ...
    function Module(modulePath) {
      ...
      _require = __bind(function(dir) {
        return __bind(function(name, options) {
          ...
          return this.tryRequire("" + this.modulePath + "/" + dir + "/" + name, options);
        }, this);
      }, this);
      /*
    ...
    Module.prototype.init = function(options) {
      ...
      return options.within = util.toJQuery(options.within);
    };
    return Module;
  })();
}).call(this);
...
"open.client/core/mvc/template": function(exports, require, module) {
  (function() {
  /*
...
"open.client/core/mvc/view": function(exports, require, module) {
  (function() {
...
"open.client/core/util/_conversion": function(exports, require, module) {
  (function() {
  module.exports = {
    /*
    ...
    toJQuery: function(value) {
      ...
      if (_.isString(value) || (value instanceof HTMLElement)) {
        return $(value);
      }
...
"open.client/core/util/index": function(exports, require, module) {
  (function() {
  var using, util;
  using = function(module) {
...
"open.client/core/util/jquery": function(exports, require, module) {
  (function() {
  /*
...
"open.client/core/util/property": function(exports, require, module) {
  (function() {
