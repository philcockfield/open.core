...
}).call(this)({"core.client/controls/button": function(exports, require, module) {(function() {
  var Button, core;
  ...
  */
  module.exports = Button = (function() {
    ...
    function Button(params) {
      ...
      this.addProps({
        pressed: (_ref = params.pressed) != null ? _ref : params.pressed = false,
        canToggle: (_ref2 = params.canToggle) != null ? _ref2 : params.canToggle = false,
        label: (_ref3 = params.label) != null ? _ref3 : params.label = ''
      });
...
}, "core.client/controls/button_set": function(exports, require, module) {(function() {
  var ButtonSet, core;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  module.exports = ButtonSet = (function() {
    ...
    ButtonSet.prototype.selected = function() {
      return (this.buttons.select(function(btn) {
        return btn.canToggle() && btn.pressed();
      }))[0];
    };
    /*
    ...
    /*
      ...
      */
    ButtonSet.prototype.addButton = function(button, options) {
      if (options == null) {
        options = {};
      }
      if (button == null) {
      ...
      button.pressed.onChanged(__bind(function(e) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          btn = _ref[_i];
          _results.push(btn !== button && btn.canToggle() && btn.pressed() ? btn.pressed(false) : void 0);
        }
        return _results;
      }, this));
      return button;
    ...
    ButtonSet.prototype.clear = function(options) {
      ...
      for (_i = 0, _len = buttons.length; _i < _len; _i++) {
        btn = buttons[_i];
        this.buttons.remove(btn, options);
      }
      if (!options.silent) {
...
}, "core.client/controls/index": function(exports, require, module) {(function() {
  module.exports = {
    Button: require('./button'),
    ButtonSet: require('./button_set')
  };
}).call(this);
}, "core.client/core/base": function(exports, require, module) {(function() {
  var Base, Property;
...
}, "core.client/core/index": function(exports, require, module) {(function() {
  var core;
  module.exports = core = {
...
}, "core.client/core/mvc/_common": function(exports, require, module) {(function() {
  module.exports = {
    /*
...
}, "core.client/core/mvc/collection": function(exports, require, module) {(function() {
...
}, "core.client/core/mvc/index": function(exports, require, module) {(function() {
  module.exports = {
    Model: require('./model'),
    View: require('./view'),
...
}, "core.client/core/mvc/model": function(exports, require, module) {(function() {
...
}, "core.client/core/mvc/template": function(exports, require, module) {(function() {
  /*
...
}, "core.client/core/mvc/view": function(exports, require, module) {(function() {
...
}, "core.client/core/util/index": function(exports, require, module) {(function() {
  module.exports = {
...
}, "core.client/core/util/property": function(exports, require, module) {(function() {
