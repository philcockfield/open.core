  ...
  */
  module.exports = Button = (function() {
    ...
    function Button(params) {
      ...
      this.selected.onChanged(__bind(function(e) {
        this._stateChanged();
        if (this.canToggle() && this.selected()) {
      ...
      (function() {
        ...
        el.mouseover(__bind(function(e) {
          self.over(true);
          return stateChanged();
        }, this));
        el.mouseout(__bind(function(e) {
          self.over(false);
          self.down(false);
          return stateChanged();
        }, this));
    ...
    Button.prototype._stateChanged = function() {
      ...
      this.stateChanged();
      return console.log('_stateChanged - ', this.label());
    };
    return Button;
  })();
}).call(this);
    ...
    ButtonSet.prototype.add = function(button, options) {
      ...
      button.selected.onChanged(__bind(function(e) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          btn = _ref[_i];
          _results.push(btn !== button && btn.canToggle() && btn.selected() ? btn.selected(false) : void 0);
        }
        return _results;
      }, this));
      return button;
