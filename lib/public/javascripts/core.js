  ...
  module.exports = Button = (function() {
    ...
    function Button(params) {
      ...
      this.addProps({
        ...
        pressed: (_ref3 = params.pressed) != null ? _ref3 : params.pressed = false,
        over: false
      });
      ...
      this.el.mouseup(__bind(function(e) {
    ...
    Button.prototype.click = function(options) {
      var fireEvent, preArgs, _ref;
      if (options == null) {
        options = {};
      }
            if ((_ref = options._togglePressed) != null) {
        _ref;
      } else {
    ...
    /*
      PRIVATE MEMBERS
      */
    Button.prototype._stateChanged = function() {
      this.trigger('stateChanged');
      this.stateChanged();
      return console.log('over: ', this.over(), ' | _mouseDown: ', this._mouseDown, ' | pressed: ', this.pressed());
    };
    return Button;
  })();
}).call(this);
